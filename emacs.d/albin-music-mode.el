...
(defconst 排行榜查询地址 "http://music.163.com/playlist"
  "获取榜单的地址")

(defconst 歌曲详情查询地址 "http://music.163.com/api/song/detail/"
  "获取mp3 json信息的地址")

(defconst albin-music-buffer-name "Qun's cloud music"
  "")
...
(defun 渲染 ()
  ...
  (erase-buffer)
  (insert-string "Qun's cloud music\n")
  (insert (propertize
...
(defun albin-music-mode ()
  ...
  (setq mode-name "Qun's cloud music")
